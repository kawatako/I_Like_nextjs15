...
import { SubmitButton } from "@/components/component/common/SubmitButton";
...
export function EditCustomProfileForm({
  userData,
}: EditCustomProfileFormProps) {
  ...
  const socialLinks: { twitter?: string; github?: string; website?: string } =
    ...
    typeof userData.socialLinks === "object" &&
    ...
    <form ref={formRef} action={formAction} className='space-y-4 max-w-full'>
      ...
      <div>
        ...
        <Input
          ...
          name='coverImageUrl'
          type='url'
          defaultValue={userData.coverImageUrl ?? ""}
          placeholder='https://...'
        />
