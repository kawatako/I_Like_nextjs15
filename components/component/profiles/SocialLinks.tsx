// components/component/SocialLinks.tsx
"use client";

import { TwitterIcon, InstagramIcon, TikTokIcon,LinkIcon } from "@/components/component/Icons";

export interface SocialLinksProps {
  links: Partial<Record<"website" | "x" | "instagram" | "tiktok", string | null>>;
  className?: string;
}
